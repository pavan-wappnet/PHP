...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql = "INSERT INTO `contactus` (`name`, `email`, `des`, `dt`) VALUES ('$name', '$email', '$desc', current_timestamp())";
        ...
        if($result){
            ...
            <strong>Error!!</strong> Your entry has not been submitted successfully. Sorry for the inconveinence.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
            </div>';;
...
<div class="container mt-3">
    ...
    <form action="/PHP/26_form.php" method="post">
