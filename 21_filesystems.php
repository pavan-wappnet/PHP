...
//1st we need to create a new folder
...
echo "<br><br>". ftell($fileread); // Position of the curser

echo "<br><br>". fseek($fileread,25); // change the Position of curser

echo "<br><br>".fgets($fileread); //now we get from 23 

echo "<br><br>". rewind($fileread); // curser position reset
